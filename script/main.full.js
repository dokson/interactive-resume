...
function orientRobby() {
    0 < deltaPageVerticalPosition && (robbyFramesDiv.style.top = "0px", robbyEyesCloseDiv.style.left = "82px"), deltaPageVerticalPosition < 0 && (robbyFramesDiv.style.top = "-200px", robbyEyesCloseDiv.style.left = "68px")
}
...
var isRobbyJumping, isRobbyFalling, swimUpHeight, layersMovement, robbyRightEdge, robbyLeftEdge, robbyMaxHorizontalDistance, canAnimateRobbyRunSwim, robbyStartFrame, robbyStopFrame, shiftRobbyFrameTimer, pageVerticalPositionWhenAnimateRobby1, pageVerticalPositionWhenAnimateRobby2, canAnimateSocialContainer, happyRobbyTimer, scrollOrSwipeTextContainerTimer, waterfallTimer, drawFireworkTimer, fireworkCenterX, fireworkCenterY, fireworkOneRadiusDistance, fireworkOneRotationAngle, drawOneLayerOfFireworkTimer, pageVerticalPosition = 0,
